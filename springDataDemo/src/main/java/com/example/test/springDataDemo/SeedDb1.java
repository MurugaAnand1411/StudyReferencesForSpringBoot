...
public class SeedDb1 {
	...
	@PostConstruct
    public void init() {
		jdbcTemplate.update("insert into EMPLOYEESSSS (name, salary, region) values (?, ?, ?)", new Object[]{"James", 1000, "London"});
        jdbcTemplate.update("insert into EMPLOYEESSSS (name, salary, region) values (?, ?, ?)", new Object[]{"Marie", 22000, "Edinburgh"});
