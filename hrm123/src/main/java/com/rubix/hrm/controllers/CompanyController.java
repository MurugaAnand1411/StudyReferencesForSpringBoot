...
public class CompanyController {
	    ...
	    @GetMapping("/{id}")
	    public ResponseEntity<Company> getInvoiceById(@PathVariable("companyId") int id) {
	    ...
	    @GetMapping
	    public List<Company> getALLInvoice() {
	      return companyService.retrieve();
	    }

	    @PutMapping
	    public String updateinvoice(@RequestBody Company comapny) {
