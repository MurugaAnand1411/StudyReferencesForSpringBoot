...
public class EmailService {
	...
	public void sendVerificationEmail(Employee employee, String siteURL)
	    ...
	    String fromAddress = "yugapriy@rubixtek.com";
	    String senderName = "Rubix Technology";
	    ...
	    content = content.replace("[[name]]", employee.getEmailId());
	    String verifyURL = siteURL + "/verify?code=" + employee.getVerificationCode()+"&&id="+employee.getEmployeeId();
